	...
	public function ajaxinsertpoll()
	{
		...
		if ($_POST['pollQuestion'] != "") {
			...
			if ($answerCount >= 2 && !$return['error']) {
				...
				// Insert actual
				$this->model->insertPoll($newPollID, $this->pollQuestion, $this->pollAnswers, $_POST['fsRandomOrder'], $_POST['fsPrivate'], $_SERVER['REMOTE_ADDR'], $_POST['fsCustomSlug'], $_POST['fsVerifiedVoting']);
