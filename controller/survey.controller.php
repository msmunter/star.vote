		...
		if ($email) {
			...
			if ($voterIDs->voterfileID) {
				...
				if ($existingVoter) {
					...
					$mVoter->insertVoterWithEmail($starVoterID, $_GET['phone'], $_GET['ipoOptIn'], $_GET['starOptIn'], $_SERVER['REMOTE_ADDR'], $email, $browser['platform'], $browser['browser'], $browser['version']);
