	...
	<div class="ui-field-contain">
		...
		<div id="identImageContainer">
			...
			<?php if ($this->identImage) { ?>
				<img id="identImagePreview" class="large" src="https://cdn.filestackcontent.com/resize=width:200,fit:clip,align:top/<?php echo $this->identImage->cdnHandle; ?>" alt="Identifying Image Preview" />
			<?php } else { ?>
				<table><tr><td>
					<img id="identImagePreview" class="small" src="/web/images/img_placeholder.svg" alt="Identifying Image Preview" />
				</td><td>
