<?php foreach($this->survey->polls as $zPoll) { ?>
	...
	Basic: <a class="ui-btn ui-mini ui-btn-inline ui-corner-all" href="/poll/csv/<?php echo $zPoll->pollID; ?>/">CSV</a>
	Advanced: <a class="ui-btn ui-mini ui-btn-inline ui-corner-all" href="/poll/csvadvanced/<?php echo $zPoll->pollID; ?>/">CSV</a>
	<table id="cvrTable">
	<?php
